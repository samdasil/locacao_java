...
public class TelaEditarServico extends javax.swing.JDialog {

    public TelaEditarServico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/servico-20x20.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEditarServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEditarServico dialog = new TelaEditarServico(new javax.swing.JFrame(), true);
    ...
    private boolean alterar(){
        ...
        if(descricao.equals("")){ 
            ...
            /** debug **/
            //JOptionPane.showMessageDialog(null, servico.getCodigo()+" - "+servico.getNome()+" - "+servico.getPrecoDiaria()+" - "+servico.getDescricao());
            //result = false;
    ...
    public void receberDados(Servico servico){
        
        jTcodigo.setText(Integer.toString(servico.getCodigo()));
        jTdescricao.setText(servico.getDescricao());

...
public class TelaServico extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTdescricao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(16, 16, 16))
        );
    ...
    private void inserir(){
        ...
        servico.setDescricao(jTdescricao.getText());
    ...
    private void buscarCodigo(){
        ...
        try {
            servico = servicoDao.buscarCodigo(codigo);
    ...
    private void deletar(){
        ...
        try {
            ...
            int opcaoExc = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja EXCLUIR o serviço: "+servico.getDescricao(), "Exclusão" ,JOptionPane.YES_NO_OPTION);

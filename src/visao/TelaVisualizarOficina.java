...
public class TelaVisualizarOficina extends javax.swing.JDialog {

    public TelaVisualizarOficina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visualizar Oficina");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizarOficina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaVisualizarOficina dialog = new TelaVisualizarOficina(new javax.swing.JFrame(), true);

...
public class TelaVisualizarMarca extends javax.swing.JDialog {

    public TelaVisualizarMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visualizar Marca");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizarMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaVisualizarMarca dialog = new TelaVisualizarMarca(new javax.swing.JFrame(), true);

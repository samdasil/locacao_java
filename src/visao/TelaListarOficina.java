 ...
 * @author Neturno
 */
public class TelaListarOficina extends javax.swing.JFrame {

    /**
     * Creates new form TelaListarMarca
     */
    public TelaListarOficina() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarOficina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarOficina().setVisible(true);
            }
        });
    }

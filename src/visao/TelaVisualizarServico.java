...
public class TelaVisualizarServico extends javax.swing.JDialog {

    public TelaVisualizarServico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visualizar Serviço");
        ...
        setSize(new java.awt.Dimension(523, 301));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizarServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaVisualizarServico dialog = new TelaVisualizarServico(new javax.swing.JFrame(), true);
